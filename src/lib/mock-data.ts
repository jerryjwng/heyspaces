...
export const mockInserate: Inserat[] = [
  {
    id: '1', user_id: 'u1', titel: 'Helle 3-Zimmer in Schwabing', beschreibung: 'Wunderschöne, lichtdurchflutete Wohnung in zentraler Lage. Frisch renoviert mit Eichenparkett und moderner Einbauküche. Balkon mit Blick ins Grüne.',
    kategorie: 'mieten', preis: 1750, flaeche: 78, zimmer: 3, strasse: 'Leopoldstraße 42', stadt: 'München', plz: '80802', verfuegbar_ab: '2025-03-01', status: 'aktiv', bilder: [IMG('photo-1502672260266-1c1ef2d93688')], created_at: '2025-01-15', owner: mockUsers[0],
  },
  {
